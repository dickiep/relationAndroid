...
class XYActivity : AppCompatActivity() {

    private lateinit var indoorLocationView: IndoorLocationView
    private lateinit var indoorLocationDisplay: TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //indoorLocationDisplay = findViewById(R.id.location_display) as TextView
        //indoorLocationDisplay.bringToFront()

        // Give location object to your view to draw it on your screen
        indoorLocationView.setLocation(location)
        Log.d("Main OnCreate", location.toString());
        ...
        indoorLocationManager.setOnPositionUpdateListener(object : OnPositionUpdateListener {
            ...
            override fun onPositionUpdate(locationPosition: LocationPosition) {
                ...
                //indoorLocationDisplay.setText(locationPosition.toString())
                //indoorLocationDisplay.setText("x = "+locationPosition.x.toString()+" y = "+locationPosition.y.toString())
                Log.d("onPositionUpdate : ","x = "+locationPosition.x.toString()+" y = "+locationPosition.y.toString())
    ...
    private fun setupLocation() {
        ...
        val locationId = "rad-store"
                //intent.extras.getString(intentKeyLocationId)
